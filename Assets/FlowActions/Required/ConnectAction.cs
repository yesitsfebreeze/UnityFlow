/// autogenerated Connect FlowAction, most likely needs manual adjustment...
...
namespace Flow.Actions
{
  ...
  public class ConnectFlowClientAction : FlowAction
  {
    ...
    private void Handle(ConnectFlowServerPackage package)
    {
      ...
      FlowClientLocal.id = package.clientId;
      Send(FlowClientLocal.id, $"Client ({FlowClientLocal.id}) was acknowledged");
    }
