...
namespace Flow.Actions
{
  ...
  public class SpawnFlowClientAction : FlowAction
  {
    ...
    private void Handle(SpawnFlowServerPackage package)
    {
      ...
      {
        GameObject prefab = Instantiate(settings.PLAYER_PREFAB, package.position, package.rotation); ;
        ClientPlayerManager.AddPlayerPrefab(prefab);
      }
      else
      {
        GameObject prefab = Instantiate(settings.ENEMY_PREFAB, package.position, package.rotation);
  ...
  public class SpawnFlowServerAction : FlowAction
  {
    ...
    {
      GameObject prefab = Instantiate(settings.SERVER_PLAYER_PREFAB, _position, _rotation);
